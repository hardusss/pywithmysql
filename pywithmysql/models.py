...
if __name__ == '__main__':
    from pywithmysql.types import IntegerField, TimeStampField, CharField, BoolField, YearField
    config = DataBaseConfig(
        "localhost",
        3306,
        "29062008Kl!",
    ...
    table = Table(
        ...
        Column("DateReg", TimeStampField, nullable=False),
        Column("IsMarried", BoolField),
        Column("Year", YearField)
    )
    print(table)
